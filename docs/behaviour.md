...
The [README](../README.md) covers what you need to use this. This page is for
...
marked **measured** come from the recorded runs in the README and can be
...
Then the recorded comparison in the README: two clean runs of the same
